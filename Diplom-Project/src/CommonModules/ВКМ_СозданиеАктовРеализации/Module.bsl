...
Функция ПроверитьДанныеАктовРеализаций(ВыбранныйПериод)
	...
	ВыбранныйМесяц = Месяц(ВыбранныйПериод);
	ВыбранныйГод = Год(ВыбранныйПериод);
	...
	|	И &Месяц МЕЖДУ МЕСЯЦ(ДоговорыКонтрагентов.ВКМ_ДатаНачалаДействияДоговора) И МЕСЯЦ(ДоговорыКонтрагентов.ВКМ_ДатаОкончанияДействияДоговора)
	|	И &Год МЕЖДУ ГОД(ДоговорыКонтрагентов.ВКМ_ДатаНачалаДействияДоговора) И ГОД(ДоговорыКонтрагентов.ВКМ_ДатаОкончанияДействияДоговора)
	|;
	|
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	...
	Запрос.УстановитьПараметр("Месяц", ВыбранныйМесяц);
	Запрос.УстановитьПараметр("Год", ВыбранныйГод);
