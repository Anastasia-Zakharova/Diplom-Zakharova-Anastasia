...
Процедура ПриОпределенииОбъектовСКомандамиПечати(СписокОбъектов) Экспорт
	...
	//ВКМ_Захарова: Добавить команду печати для документа "РеализацияТоваровУслуг"
...
Процедура ПриПолученииПодписейИПечатей(Документы, ПодписиИПечати) Экспорт
	...
	//ВКМ_Захарова: Подписи и Печати для печати документа "Реализация товаров и услуг"
	Для Каждого Документ Из Документы Цикл
		Организация = ОбщегоНазначения.ЗначениеРеквизитаОбъекта(Документ, "Организация");
		//Получаем комплект подписи и печати (код в модуле менеджера справочника "Организации"
		КомплектПодписейИПечатей = Справочники.Организации.ПолучитьПодписиИПечати(Организация);
		//Заполняем соответствие ПодписиИпечати
